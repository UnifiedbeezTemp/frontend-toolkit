...
interface ZoomConnectionDetailsProps {
...
export default function ZoomConnectionDetails({
  connection,
  onDelete,
  isDeleting,
  variant = "desktop",
}: ZoomConnectionDetailsProps) {
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between gap-4">
              ...
              <div
                ...
                title={String(connection.configuration?.email || "")}
              >
                <Text size="sm" className="text-text-secondary">
                  {String(connection.configuration?.email || "")}
                </Text>
              </div>
            </div>
            <div className="flex items-center justify-between gap-4">
              ...
              <div
                className="truncate max-w-[20rem]"
                title={String(connection.configuration?.displayName || "")}
              >
                <Text size="sm" className="text-text-secondary">
                  {String(connection.configuration?.displayName || "")}
                </Text>
              </div>
            </div>
