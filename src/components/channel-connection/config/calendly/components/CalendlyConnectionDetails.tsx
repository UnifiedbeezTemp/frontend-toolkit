...
import { extractCalendlyDisplayData } from "../utils/calendlyConnectionDisplayUtils";

interface CalendlyConnectionDetailsProps {
...
export default function CalendlyConnectionDetails({
  connection,
  onDelete,
  isDeleting,
  variant = "desktop",
}: CalendlyConnectionDetailsProps) {
  ...
  const { email, displayName, timezone } =
    extractCalendlyDisplayData(connection);
        ...
        >
          <div className="flex items-center gap-4">
            <div>
              <Heading size="lg" className="text-[1.8rem]">
                {displayName || "Calendly Connected"}
              </Heading>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="truncate max-w-[20rem]" title={displayName || ""}>
                <Text size="sm" className="text-text-secondary">
                  {displayName}
                </Text>
              </div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="truncate max-w-[20rem]" title={email || ""}>
                <Text size="sm" className="text-text-secondary">
                  {email}
                </Text>
              </div>
            ...
            {timezone && (
              <div className="flex items-center justify-between gap-4">
                ...
                <div className="truncate max-w-[20rem]" title={timezone}>
                  <Text size="sm" className="text-text-secondary">
                    {timezone}
                  </Text>
                </div>
