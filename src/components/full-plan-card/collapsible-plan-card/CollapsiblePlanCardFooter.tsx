...
export default function CollapsiblePlanCardFooter({
  ...
  const ctaText = useMemo(() => {
    ...
    else if (isLowerThanCurrentPlan)
      return "Downgrade"
    return plan.ctaText
  }, [isLowerThanCurrentPlan, isCurrentPlan])
  return (
    <div className="pt-2.25 px-5.5 border-t border-t-border/70">
      <Button
        className={cn(
          "w-full border border-brand-primary rounded-md py-2 text-md font-normal disabled:pointer-events-none",
