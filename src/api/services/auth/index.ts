...
export const authService = {
  ...
  getPaymentMethod: trialService.getPaymentMethod,
  createSetupIntent: trialService.createSetupIntent,
  updatePaymentMethod: trialService.updatePaymentMethod,
  switchPlan: trialService.switchPlan,
