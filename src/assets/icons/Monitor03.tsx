...
export default function Monitor03({
  size = 19,
  color = "currentColor",
  className,
  ...props
  ...
  return (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} stroke={color} {...props}>
